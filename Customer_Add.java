...
public class Customer_Add {
    ...
    JLabel Name_Label, Contact_Label, Email_Label, UserName_Label, Password_Label, contactValidity_Label, NameValidity_Label, EmailValidity_Label, UserNameValidity_Label, PasswordValidity_Label;
    JTextField  Name_TextField, Contact_TextField, Email_TextField, UserName_TextField, Password_TextField;
                    ...
                    String contact = Contact_TextField.getText().trim();
                            ...
                            if (Customer.isNameValid(name)) {
                                if (Customer.isContactNoValid(contact)) {
                                    new Customer(0, 0,  name, contact).Add(); // ID is Auto
