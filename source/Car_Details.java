...
public class Car_Details {
    ...
    private static JButton SearchName_Button, SearchRegNo_Button, Add_Button, Remove_Button, BackButton, LogoutButton;
    ...
    public Car_Details() {
        ...
        Parent_JFrame.getMainFrame().setTitle("Car Details ");
        ...
        String[] columns = {"Sr#", "ID", "Maker", "Name", "Colour", "Type", "Seats", "Model", "Condition", "Reg No.", "Rent/hour"};
...
//        jTable1.setPreferredScrollableViewportSize(new Dimension(2000, 550));
        ...
        for (int i = 0; i < Car_objects.size(); i++) {
            ...
            String[] one_s_Record = {((i + 1) + ""), "" + ID, maker, Name, color, type, seatingCapacity+"",
                model, condition, regNo, rentPerHour + "", customerID + ": " + customerName};
